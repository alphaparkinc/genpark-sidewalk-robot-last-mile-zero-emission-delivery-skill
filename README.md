# genpark-sidewalk-robot-last-mile-zero-emission-delivery-skill
...
> **GenPark AI Agent Skill** -- Sidewalk teleoperated delivery robot dispatcher and zero-emission transit (Coco style)
